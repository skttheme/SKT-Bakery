...
function skt_bakery_setup() {
	...
	load_theme_textdomain( 'skt-bakery', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'skt-bakery' ),
	) );
...
function skt_bakery_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Blog and Page Sidebar', 'skt-bakery' ),
		'description'   => __( 'Appears on blog and page sidebar', 'skt-bakery' ),
		'id'            => 'sidebar-1',
	...
	register_sidebar( array(
		'name'          => __( 'Twitter Widget', 'skt-bakery' ),
		'description'   => __( 'Appears on footer of the page', 'skt-bakery' ),
		'id'            => 'twitter-wid',
...
function skt_bakery_font_url(){
		...
		*/
		$roboto = _x('on', 'Roboto font:on or off','skt-bakery');
		
		/* Translators: If there are any character that are not
		* supported by Oswald, trsnalate this to off, do not
		* translate into your own language.
		*/
		$oswald = _x('on','Oswald:on or off','skt-bakery');
		
		/* Translators: If there has any character that are not supported 
		*  by Scada, translate this to off, do not translate
		*  into your own language.
		*/
		$scada = _x('on','Scada:on or off','skt-bakery');
		
		
		$sail = _x('on','Sail:on or off','skt-bakery');
		
		$robotocondensed = _x('on','Roboto Condensed:on or off','skt-bakery');
		
		$pacifico = _x('on','Pacifico:on or off','skt-bakery');
...
define('SKT_THEME_URL_DIRECT','https://www.sktthemes.org/shop/bakery-lite/');
define('SKT_THEME_DOC','https://sktthemesdemo.net/documentation/skt-bakery-doc/');
define('SKT_PRO_THEME_URL','https://www.sktthemes.org/shop/bakery-wordpress-theme/');
