...
<?php /*?>        <div class="spacer40"></div>
        ...
        <div class="site-aligner">
            ...
            <div class="mobile_nav"><a href="#"><?php _e('Go To...','skt-bakery'); ?></a></div>
            <div class="site-nav">
...
<div class="feature-box-main site-aligner">
        ...
        <a href="#"><div class="feature-box <?php if($bx%5==0){ ?>last<?php } ?>">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/icon<?php echo $bx; ?>.jpg" />
            <h2><?php _e('Page Title','skt-bakery'); ?><?php echo $bx-1; ?></h2>
            <p><?php _e('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis malesuada ex non magna convallis aliquam','skt-bakery');?></p>
        </div></a>
        <!-- feature-box -->
        <?php if($bx%5==0) { ?>
        <div class="clear"></div>
